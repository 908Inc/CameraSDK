...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "vlad"
  # s.authors            = { "vlad" => "vladhatko@gmail.com" }
  # s.social_media_url   = "http://twitter.com/vlad"
  ...
  s.source = { :git => "file:///Users/vlad/Work/908/CameraSDK/", :tag => "0.0.1" }
